...
fn main() {
    ...
    "KR" => hashmap!["69" => (1515024000, 1522281600), "71"=> (1522281600, 1530025242), "74"=> (1530025242, 1531389600), "75" => (1531389600, u64::max_value())],
    ...
    "THA" => hashmap!["66" => (u64::min_value(), 1522886400), "67" => (1522886400, 1525824000), "68"=>(1525824000, 1528279200), "69" => (1528279200, u64::max_value())],
